...
+left W — добавить вагон с номером 
�
W слева
+right W — добавить вагон с номером 
�
W справа
-left N — отцепить и убрать 
�
N вагонов слева
-right N — отцепить и убрать 
�
N вагонов справа
В последних двух командах 
�
N может быть больше текущей длины состава — в этом случае надо убрать весь состав целиком. Отцеплять вагоны по одному может быть долго: постарайтесь сразу отцеплять по 
�
N штук. Напечатайте через пробел номера вагонов получившегося состава, если смотреть на них слева направо. В самом конце напечатайте перевод строки.
