/* 
  ...
  │
  │  можно напечатать в поток std::cout с помощью стандартного оператора <<.   │
  │ Второй аргумент функции — строка-разделитель, которую надо печатать между  │
  │ элементами. В конце необходимо напечатать перевод строки                   │
  │ \n.
                                                                       │
  │ 
                                                                          │
  ...
  │ Подключите все необходимые для реализации библиотеки. Используйте          │
  │ константные ссылки для получения параметров и при итерации в цикле, чтобы  │
  │ избежать лишних копирований: если этого не сделать, то программа не        │
  │ скомпилируется.
  │                                                                            │
  └────────────────────────────────────────────────────────────────────────────┘
 */
